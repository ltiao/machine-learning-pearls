#!/usr/bin/env python
#
# scribbles documentation build configuration file, created by
...
version = scribbles.__version__
# The full version, including alpha/beta/rc tags.
release = scribbles.__version__
...
htmlhelp_basename = 'scribblesdoc'
