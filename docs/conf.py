#!/usr/bin/env python
#
# etudes documentation build configuration file, created by
...
version = etudes.__version__
# The full version, including alpha/beta/rc tags.
release = etudes.__version__
...
latex_documents = [
    (master_doc, 'etudes.tex',
     'Machine Learning Études Documentation',
     'Louis C. Tiao', 'manual'),
]
